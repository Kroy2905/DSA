package Algorithm.KruskalsAlgorithm;
...
import MinimumSpanningTree.DisjointSet;
...
public class Kruskals {
  ...
  public Kruskals(ArrayList<WeightedNode> nodeList) {
  ...
  public void addWeightedUndirectedEdge(int firstIndex, int secondIndex, int weight) {
    ...
    edgeList.add(edge);  // adding to the list to sort later 
  }
  ...
  void kruskal() {
    ...
    Comparator<UndirectedEdge> comparator = new Comparator<UndirectedEdge>() {
      ...
      public int compare(UndirectedEdge o1, UndirectedEdge o2) {
        return o1.weight - o2.weight;  // comparasion using weight 
      }
    };
